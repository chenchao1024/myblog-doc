...
ParticleFactory.shapeMap = new Map([
  ["star", Star],
  ["circle", Circle]
]);
class Boom {
  constructor(shape, origin, size, numParticles) {
    ...
    this.stopped = false;
    __privateSet(this, _particles, new Set());
...
var PopperShape;
(function(PopperShape2) {
  PopperShape2["Star"] = "star";
  PopperShape2["Circle"] = "circle";
})(PopperShape || (PopperShape = {}));
class Popper {
  constructor({ shape = PopperShape.Star, size = 2, numParticles = 10 } = {}, canvasOptions = {}) {
    ...
    __privateAdd(this, _booms, new Set());
