...
class EventsHandler {
  constructor() {
    ...
    __privateSet(this, _eventMap, new Map());
  }
  add(type, listener) {
    var _a;
    if (!__privateGet(this, _eventMap).has(type)) {
      __privateGet(this, _eventMap).set(type, new Set());
    }
...
function showBadge(appName, {
  ...
  console.log(`%c ${appName} %c v${"0.3.0"} ${"a51a037"} %c`, `background: ${leftBgColor}; padding: 2px; color: ${leftColor}; font-weight: bold; text-transform: uppercase;`, `background: ${rightBgColor}; padding: 2px; color: ${rightColor}; font-weight: bold; text-transform: uppercase;`, "background: transparent");
}
